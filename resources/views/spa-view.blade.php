        ...
        <div class="loading-wrapper">
            <div class="loading-content">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M5 1c-1.105 0-2 .9-2 2v19c0 1.1.895 2 2 2h14c1.105 0 2-.9 2-2V3c0-1.1-.895-2-2-2H5z"
                        fill="#2b7014"></path>
                    <path d="M6 1c-1.105 0-2 .9-2 2v18c0 1.1.895 2 2 2h12c1.105 0 2-.9 2-2V3c0-1.1-.895-2-2-2H6z"
                        fill="#ecf0f1"></path>
                    ...
                    <path
                        ...
                        fill="#2b7014"></path>
                    <path d="M2 4v1h2V4H2zm0 3v1h2V7H2zm0 3v1h2v-1H2zm0 3v1h2v-1H2zm0 3v1h2v-1H2zm0 3v1h2v-1H2z"
                        fill="#95a5a6"></path>
                    <path d="M5 1c-1.105 0-2 .9-2 2v19c0 1.1.895 2 2 2h1c-1.105 0-2-.9-2-2V3c0-1.1.895-2 2-2H5z"
                        fill="#518f3c"></path>
                    <path d="M3 4v1h1V4H3zm0 3v1h1V7H3zm0 3v1h1v-1H3zm0 3v1h1v-1H3zm0 3v1h1v-1H3zm0 3v1h1v-1H3z"
                        fill="#2b7014"></path>
                    <g fill="#bdc3c7">
                        <path
                            d="M2 3v1h1V3H2zm0 3v1h1V6H2zm0 3v1h1V9H2zm0 3v1h1v-1H2zm0 3v1h1v-1H2zm0 3v1h1v-1H2zM2 3c-.552 0-1 .4-1 1 0 .5.448 1 1 1V3zM2 6c-.552 0-1 .4-1 1 0 .5.448 1 1 1V6zM2 9c-.552 0-1 .4-1 1 0 .5.448 1 1 1V9zM2 12c-.552 0-1 .4-1 1 0 .5.448 1 1 1v-2zM2 15c-.552 0-1 .4-1 1 0 .5.448 1 1 1v-2zM2 18c-.552 0-1 .4-1 1 0 .5.448 1 1 1v-2z">
                        </path>
                    </g>
                    <path d="M3 3v1h1V3H3zm0 3v1h1V6H3zm0 3v1h1V9H3zm0 3v1h1v-1H3zm0 3v1h1v-1H3zm0 3v1h1v-1H3z"
                        fill="#95a5a6"></path>
                </svg>
