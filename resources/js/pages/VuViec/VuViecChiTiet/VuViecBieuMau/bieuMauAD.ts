export const ad: BieuMau.Item[] = [
	{
		...
		childs: [
			...
			{ path: 'BBTraoDoiVKS.docx', name: 'Biên bản trao đổi Viện Kiểm sát', lanh_dao: true },
			{ path: 'BCDXChuyenNguonTin.docx', name: 'Báo cáo đề xuất chuyển nguồn tin', lanh_dao: true },
	...
	},
	{
		...
		childs: [
			{ path: 'B10CGiaHanNguonTin.docx', name: 'Thông báo kết quả xác minh', lanh_dao: true },
			{ path: 'BBThongBaoGiaHanXacMinh.docx', name: 'Biên bản thông báo gia hạn xác minh', lanh_dao: true },
			{
				path: 'BCDXGiaHanXacMinhNguonTinTp.docx',
				name: 'Báo cáo đề xuất gia hạn xác minh nguồn tin',
				lanh_dao: true,
			},
			{ path: 'DeNghiGiaHanXacMinhNguonTinTP.docx', name: 'Đề nghị gia hạn xác minh nguồn tin', lanh_dao: true },
			{
	...
	},
	{
		...
		childs: [
			...
			{
				path: 'TBaoVeViecKhongChapNhanGiamDinhBoSung.docx',
				name: 'Thông báo về việc không chấp nhận giám định bổ sung',
				lanh_dao: true,
			},
		],
	},
	{
		...
		name: 'Giám định lại',
		childs: [
			{ path: 'QDTrungCauGiamDinhLai.docx', name: 'QĐ trưng cầu giám định lại', lanh_dao: true },
			{
				path: 'TBaoVeViecKhongChapNhanGiamDinhLai.docx',
				name: 'Thông báo về việc không chấp nhận giám định lại',
				lanh_dao: true,
			},
		],
	},
	{
		...
		childs: [
			...
			{
				path: 'BCDXKeoDaiXacMinhDen2Thang.docx',
				name: 'Báo cáo đề xuất kéo dài thời hạn xác minh đến 2 tháng',
				lanh_dao: true,
			},
			{
	...
	},
	{
		...
		childs: [
			{ path: 'B10CNguonTin.docx', name: 'Thông báo kết quả xác minh', lanh_dao: true },
			{ path: 'BanDinhAD.docx', name: 'Bản định', lanh_dao: true },
			{ path: 'BaoCaoKetThuc.docx', name: 'Báo cáo kết thúc', lanh_dao: true },
			{ path: 'BBThongBaoKhongKhoiTo.docx', name: 'Biên bản thông báo không khởi tố', lanh_dao: true },
			{ path: 'BCDXKhongKhoiTo.docx', name: 'Báo cáo đề xuất không khởi tố', lanh_dao: true },
			{ path: 'KetThucAD.docx', name: 'Kết thúc', lanh_dao: true },
			{ path: 'QDKhongKhoiTo.docx', name: 'Quyết định không khởi tố', lanh_dao: true },
	...
	},
	{
		...
		childs: [
			...
			{ path: 'BCDXPhanCongNguonTin.docx', name: 'Báo cáo đề xuất phân công nguồn tin', lanh_dao: true },
			{ path: 'KHXMNguonTin.docx', name: 'Kế hoạch xác minh nguồn tin', lanh_dao: true },
			{ path: 'LapHoSoAD.docx', name: 'Lập', lanh_dao: true },
			{ path: 'QDPhanCongDTVGiaiQuyet.docx', name: 'Quyết định phân công điều tra viên', lanh_dao: true },
			{ path: 'QDPhanCongPTTGiaiQuyet.docx', name: 'Quyết định phân công Phó thủ trưởng', lanh_dao: true },
	...
	},
	{
		...
		childs: [
			...
			{ path: 'BCDXPhucHoi.docx', name: 'Báo cáo đề xuất phục hồi', lanh_dao: true },
			{ path: 'QDPhucHoiNguonTin.docx', name: 'Quyết định phục hồi nguồn tin', lanh_dao: true },
			{ path: 'ThongbaoVeViecPhucHoi.docx', name: 'Thông báo về việc phục hồi', lanh_dao: true },
		],
	},
	{
		path: 'TamDinhChiAD',
		name: 'Tạm đình chỉ vụ việc',
		childs: [
			{ path: 'B10CNguonTin.docx', name: 'Thông báo kết quả xác minh', lanh_dao: true },
			{ path: 'BaoCaoKetThuc.docx', name: 'Báo cáo kết thúc', lanh_dao: true },
	...
	},
	{
		...
		childs: [
			...
			{
				path: 'BCDXVeViecTBKLDG.docx',
				name: 'Báo cáo đề xuất về việc Thông báo kết luận định giá',
				lanh_dao: true,
			},
		],
	},
	{
		...
		childs: [
			...
			{
				path: 'BCDXVeViecTBKLGD.docx',
				name: 'Báo cáo đề xuất về việc thông báo kết luận giám định',
				lanh_dao: true,
			},
		],
	},
